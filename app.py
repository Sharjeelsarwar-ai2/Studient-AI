...
.main [data-testid="stTabs"]:has(.sm-parent-nav-heading) > div[data-baseweb="tab-list"] { display:flex !important; width:100%; min-height:64px; padding:0 !important; gap:0 !important; position:sticky !important; top:3.15rem; z-index:40; border-radius:0 0 24px 24px; overflow:hidden; background:linear-gradient(105deg,rgba(224,231,255,.96),rgba(255,255,255,.92) 50%,rgba(253,242,255,.96)) !important; border-bottom:1px solid rgba(124,58,237,.18); box-shadow:0 10px 26px rgba(31,25,90,.14) !important; }
.main [data-testid="stTabs"]:has(.sm-parent-nav-heading) > div[data-baseweb="tab-list"] [data-baseweb="tab"] { flex:1 1 0; justify-content:center; min-height:64px; padding:14px 24px !important; border-radius:0; margin:0 !important; border-right:1px solid rgba(124,58,237,.10); font-size:18px !important; font-weight:800; color:var(--ink-soft); }
.main [data-testid="stTabs"]:has(.sm-parent-nav-heading) > div[data-baseweb="tab-list"] [data-baseweb="tab"]:last-child { border-right:none; }
...
@media (max-width: 700px) {
  ...
  .main [data-testid="stTabs"]:has(.sm-parent-nav-heading) > div[data-baseweb="tab-list"] { position:sticky !important; top:3rem; min-height:56px; padding:0 !important; gap:0 !important; border-radius:0 0 17px 17px; }
  .main [data-testid="stTabs"]:has(.sm-parent-nav-heading) > div[data-baseweb="tab-list"] [data-baseweb="tab"] { min-height:56px; padding:9px 5px !important; font-size:12px !important; border-radius:0; }
